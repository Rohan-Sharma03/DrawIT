 ...
 * https://twiserandom.com/android/graphics/what-is-a-bitmap-in-android/index.html
 */
...
class DrawingView(context: Context, attrs: AttributeSet) : View(context, attrs) {
     ...
     *  Bitmap(main background)
     *             II
     *            V  V
     *             V
     *  canvas(it allows to draw text,other shapes on bitmap)
     *             II
     *            V  V
     *             V
     *  paint(it allows to style the shape drawn in canvas)
     *
     */
    ...
    //saving paths in array list.
    private val undopaths = ArrayList<CustomPath>()
    //saving deleted paths
